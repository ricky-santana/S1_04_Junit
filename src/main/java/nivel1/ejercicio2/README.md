...
- Probé al principio a Objects O en mis objetos para poder lanzar el InvalidTipeNif en vez del InputMismatchException, y así tener el mensaje que quiero dentro de la excepción, vi que no podía y lo cambié por Strings.
